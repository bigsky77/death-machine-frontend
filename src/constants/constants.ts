...
export const BLANK_SOLUTION: Solution = {
    ships: [
        {id: 'ship0', type: 1, status: 1, index: { x:0, y:0 }, description: 1, pc_next: 0, selected: false},
        {id: 'ship1', type: 1, status: 1, index: { x:1, y:0 }, description: 2, pc_next: 0, selected: false},
